    ...
    <div class="super_container">
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="header_content d-flex flex-row align-items-center justify-content-between">
                                <div class="logo">
                                    <a href="#">
                                        <img src="{{ asset('assets/images/logo.png') }}" alt="Sankofa Logo" class="img-fluid"
                                            height="120">
                                    </a>
                                </div>
                                <nav class="main_nav">
                                ...
                                <div class="header_extra">
                                    ...
                                    <div class="shopping_cart hassubs">
                                        <a href="#">
        ...
        <div class="menu menu_mm trans_300">
            ...
            <div class="menu_close">
                <img src="assets/images/svg/cross.svg" alt="" width="17">
            </div>
                ...
                <div class="row">
                    <div class="col">
                        <div
                            ...
                            <div class="footer_logo"><a href="#"><img src="assets/images/logo.png" alt="" height="80"></a></div>
